...
Don't forget, if the information from a few slides ago, you can find it in your notes. 

### Your turn

Navigate in the Viewer pane using the *floating table of contentes* to the image of Hillary Clinton in the section called **A fitting dataset**.
...
From now on, you can take notes directly into the script file for these slides. 

Let's create a section at the top of the document called **Useful tips**.

Create a heading directly above the section called **Hi**: it looks likes this at the top of the script file.
```
## Hi! 
```
