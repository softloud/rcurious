...
- the pew-pew sound my gun makes startles me
- normal
- hardcore
...
## Image search: "witch" + "julia gillard"
...
<center>
<img src="https://alloftheones.files.wordpress.com/2014/04/ezgif-save.gif" style="width:70%">
</center>
...
We're almost ready to begin our analysis.
...
We can import this data using the `read_csv()` function from the `tidyverse`. We pass the url between the () as a "character string".   

### Your turn

Open a code chunk *here* and assign `<-` the data to an object called `witchdat`
